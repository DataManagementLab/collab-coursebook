...
/**
 * This method updates the AddAnkiDeck form by replacing the element with the provided label
 * with the element saved in form_attach, if an element with such label exists in the form.
 * The element's position is relative to the position of the 'Options' field in AddAnkiDeck, so
